  ...
  async runCommand(raw) {
    ...
    try {
      switch (cmd.toLowerCase()) {
        case 'help':
          Logger.info('console', 'commands: /help /providers /keys /test <providerId> /session /keybinds /devices /auth /clear /export /storage /reset <setting> /theme <name> /whoami /ping all');
          break;
        case 'clear':
          Logger.clear();
          break;
