  ...
  async render() {
    ...
    html += `
      <div class="settings-group" id="appearanceGroup">
        ...
        <div class="settings-row" style="align-items:flex-start">
          <label style="padding-top:5px">Chat bubbles</label>
          <div style="flex:1;display:flex;flex-direction:column;gap:8px">
            <div style="display:flex;align-items:center;gap:8px">
              <span style="font-size:11px;color:var(--text-muted);min-width:70px">transparency</span>
              <input type="range" id="bubbleOpacityInput" min="0.35" max="1" step="0.05" value="${bubbleOpacity}" style="flex:1" />
            </div>
            <div style="display:flex;align-items:center;gap:8px">
              <span style="font-size:11px;color:var(--text-muted);min-width:70px">blur</span>
              <input type="range" id="bubbleBlurInput" min="0" max="16" step="1" value="${bubbleBlur}" style="flex:1" />
            </div>
            <div style="font-size:11px;color:var(--text-muted)">Most visible with a background image set - makes bubbles glassy instead of solid.</div>
          </div>
        </div>
      </div>`;
